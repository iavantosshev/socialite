				...
				<table class="table existing-products-table socialite">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="#"><img src="<?php echo e($timeline->user->avatar); ?>" alt="images"></a><a href="<?php echo e(url($timeline->username)); ?>"> <?php echo e($timeline->name); ?></a></td>
							...
							<td>
								<ul class="list-inline">
									...
									<li><a href="<?php echo e(url('admin/users/'.$timeline->user->id.'/delete')); ?>" onclick="return confirm('<?php echo e(trans("messages.are_you_sure")); ?>')"><span class="trash-icon bg-danger"><i class="fa fa-trash" aria-hidden="true"></i></span></a></li>
								</ul>
